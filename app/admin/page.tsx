...
export default function AdminDashboard() {
  ...
  const downloadExcel = () => {
    ...
    // --- FIX: ATUR LEBAR KOLOM AGAR RAPI ---
    // wch = width characters (lebar dalam satuan karakter)
    worksheet["!cols"] = [
      { wch: 20 }, // Kolom A: Order ID
      { wch: 15 }, // Kolom B: Tanggal
      { wch: 10 }, // Kolom C: Waktu
      { wch: 20 }, // Kolom D: Nama Pelanggan
      { wch: 15 }, // Kolom E: No. WhatsApp
      { wch: 12 }, // Kolom F: Status
      { wch: 15 }, // Kolom G: Total Bayar
      { wch: 80 }, // Kolom H: Rincian Menu (Dibuat sangat lebar agar muat)
    ];

    // 3. Buat Workbook & Download
